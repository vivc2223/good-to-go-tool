                  ...
                  <div className="flex flex-col">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      >
                        ...
                        elit. Molestias praesentium perspiciatis laborum
                      </h2>
                      <div
                        style={{
                          color: "white",
                    ...
                    >
                      ...
                      Iusto incidunt vitae officiis quam reiciendis corporis
                      pariatur est rerum nobis eaque!
                    </p>
                  ...
                  <div className="">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex flex-col">
                        ...
                        >
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Iusto incidunt vitae officiis quam reiciendis
                          corporis pariatur est rerum nobis eaque!
                        </p>
