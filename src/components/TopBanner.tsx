...
const TopBanner = () => {
  return (
    <div className="fixed top-0 left-0 right-0 z-[9999] bg-white text-black py-3 px-1 sm:px-6 md:px-8">
      <div className="max-[430px]:text-xs max-[368px]:text-[10px] max-w-7xl md:mx-auto flex flex-row flex-wrap items-center justify-center gap-2  sm:text-sm md:text-base">
